...
public class Test3SimpleBeanConversion {
	...
	static ReversibleFunction<TypedAtom<String, String>, Tuple<String, Integer>> ENTRY_TO_TUPLE = Reversible.function(
	...
	static ReversibleFunction<TestBean1, TestBean2> TEST_BEAN_1_TO_2 = Reversible.function(
